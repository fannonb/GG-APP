...
/** ISO 3166-1 alpha-2 countries for residence selection (includes operating markets). */
export const WORLD_COUNTRIES: Array<{ code: string; name: string }> = [
...
export function getWorldCountryByName(name: string) {
