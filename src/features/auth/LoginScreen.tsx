  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: isMobile ? '28px 20px 32px' : '0 40px',
        background: '#fff',
      }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ textAlign: 'right', marginBottom: '14px' }}>
            <span style={{ fontSize: '13px', color: C.blue500, fontWeight: 600, cursor: 'pointer' }}>Forgot password?</span>
          </div>
          ...
          <div style={{ textAlign: 'center', fontSize: '13px', color: C.textSub, marginTop: '14px' }}>
            No account?{' '}
